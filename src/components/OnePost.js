...
export default function OnePost() {
    ...
    return (
        <div className="bg-gray-500 min-h-screen p-12">
            <div className="container shadown-lg mx-auto bg-green-100 rounded-lg">
                <div className="relative">
                    ...
                    <img className="w-full object-cover rounded-t"
                        style={{ height: "400px" }}
                        src={urlFor(postData.mainImage).width(200).url()}
                        alt="main post"
                    />
                </div>
                <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full bg-green-200">
                    <BlockContent
